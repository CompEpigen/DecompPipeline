...
#' @param save.report Flag indicating if a report is to be created and stored for ICA
#' @param alpha.feat Significance level detecting features contributing to components 
