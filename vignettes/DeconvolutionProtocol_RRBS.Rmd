...
# Deconvolution
Deconvolutiom is applied analogously to the [general protocol](protocol.html). [*RefFreeCellMix*](https://cran.r-project.org/web/packages/RefFreeEWAS/index.html) and [*EDec*](https://github.com/BRL-BCM/EDec) can be used as alternative deconvolution methods.
