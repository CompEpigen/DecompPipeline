...
rnb.set <- load.rnb.set("http://epigenomics.dkfz.de/downloads/DecompProtocol/rnbSet_unnormalized.zip")
```
...
download.file("http://epigenomics.dkfz.de/downloads/DecompProtocol/FactorViz_outputs.tar.gz")
